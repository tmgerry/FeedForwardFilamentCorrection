...
class GCodeMove:
    def __init__(self, config):
        ...
        gcode.register_command('GET_EXTRUDE_FACTOR', self.cmd_GET_EXTRUDE_FACTOR)
    ...
    def M221_BYPASS(self, extrude_factor):
        # Set extrude factor override percentage but bypass the lookahead que
    ...
    def cmd_GET_EXTRUDE_FACTOR(self, gcmd):
        gcmd.respond_info(f"Extrude Factor: {self.extrude_factor}")
